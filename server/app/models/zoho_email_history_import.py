...
class ZohoEmailHistoryImport(TimestampMixin, Base):
    """Durable progress for the one-time import of every Zoho email header."""

    __tablename__ = "zoho_email_history_imports"
    ...
    imported_emails: Mapped[int] = mapped_column(Integer(), nullable=False, default=0)
